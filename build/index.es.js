...
var react_5 = react.useContext;
var react_6 = react.useMemo;
...
var react_14 = react.Fragment;
var react_15 = react.forwardRef;
...
const NavigationContext = /*#__PURE__*/react_2(null);

if (process.env.NODE_ENV !== "production") {
  NavigationContext.displayName = "Navigation";
}

const LocationContext = /*#__PURE__*/react_2(null);

if (process.env.NODE_ENV !== "production") {
  LocationContext.displayName = "Location";
}

const RouteContext = /*#__PURE__*/react_2({
  outlet: null,
  matches: []
});
...
function useInRouterContext() {
  return react_5(LocationContext) != null;
}
/**
...
function useLocation() {
  ...
  return react_5(LocationContext).location;
}
/**
...
function useNavigate() {
  ...
  let {
    matches
  } = react_5(RouteContext);
  let {
    pathname: locationPathname
  } = useLocation();
  let routePathnamesJson = JSON.stringify(matches.map(match => match.pathnameBase));
  let activeRef = react_7(false);
  react_8(() => {
    activeRef.current = true;
  });
  let navigate = react_9(function (to, options) {
    if (options === void 0) {
      options = {};
    }
...
function useResolvedPath(to) {
  ...
  let routePathnamesJson = JSON.stringify(matches.map(match => match.pathnameBase));
  return react_6(() => resolveTo(to, JSON.parse(routePathnamesJson), locationPathname), [to, routePathnamesJson, locationPathname]);
}
/**
...
function _renderMatches(matches, parentMatches) {
  ...
  return matches.reduceRight((outlet, match, index) => {
    return /*#__PURE__*/react_4(RouteContext.Provider, {
...
function Router$1(_ref3) {
  ...
  return /*#__PURE__*/react_4(NavigationContext.Provider, {
    value: navigationContext
  }, /*#__PURE__*/react_4(LocationContext.Provider, {
    children: children,
    value: {
      location,
      navigationType
...
function createRoutesFromChildren(children) {
  let routes = [];
  react_12.forEach(children, element => {
    if (! /*#__PURE__*/react_13(element)) {
      // Ignore non-elements. This allows people to more easily inline
      // conditionals in their route config.
      return;
    }

    if (element.type === react_14) {
...
function BrowserRouter(_ref) {
  ...
  let [state, setState] = react_10({
    action: history.action,
    location: history.location
  });
  react_11(() => history.listen(setState), [history]);
  return /*#__PURE__*/react_4(Router$1, {
    basename: basename,
    children: children,
 ...
 */
const Link = /*#__PURE__*/react_15(function LinkWithRef(_ref4, ref) {
  let {
    onClick,
    reloadDocument,
    replace = false,
 ...
 */
const NavLink = /*#__PURE__*/react_15(function NavLinkWithRef(_ref5, ref) {
  let {
  ...
  return /*#__PURE__*/react_4(Link, _extends({}, rest, {
...
const Router = () => {
    return (react.createElement(BrowserRouter, null,
        react.createElement(Routes, null,
            react.createElement(Route, { path: "/", element: react.createElement(MyPage, null) }),
